...
<body>
	...
	<div class="container">
		<div class="col-md-10">
	<form action="{{route('order.store')}}" method="POST" role="form" style="margin-top: 300px;">
        @csrf
		<legend>Form title</legend>
    @if(Auth::check())
		<div class="form-group">
			<label for="">Name</label>
			<input type="text" name="name" id="name"  class="form-control" value="{{Auth::user()->name}}" placeholder="Input field">
		</div>
    @endif
		<div class="form-group">
			<label for="">Noi dung</label>
			<input type="text" name="noidung" id="noidung" class="form-control" value="" placeholder="Input field">
		</div>
		<div class="form-group">
			<label for="">Addess</label>
			<input type="text" name="diachi" id="diachi" class="form-control" value="" placeholder="Input field">
		</div>
		<div class="form-group">
			<label for="">Phone</label>
			<input type="number" name="sodt" id="sodt" class="form-control" value="" placeholder="Input field">
		</div>
		
        <p>Thanh toan khi mhan hang</p>
  		 @if(Auth::check())
  		<div class="form-group">
      ...
      @else
      <div class="form-group">
        <a href="{{ route('dangnhap') }}"><button class="btn btn-primary">Submit</button></a>
      </div>
      @endif
	</form>
</div>
